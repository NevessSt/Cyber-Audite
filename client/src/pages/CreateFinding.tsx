...
import type { AuditFinding, CreateFindingInput } from '../services/findingService';
...
const SEVERITY_LEVELS: AuditFinding['severity'][] = ['CRITICAL', 'HIGH', 'MEDIUM', 'LOW'];
...
const CreateFinding: React.FC = () => {
  ...
  const handleSeverityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setFormData({ ...formData, severity: e.target.value as AuditFinding['severity'] });
  };
